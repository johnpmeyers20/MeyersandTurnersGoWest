...
_**MeyersandTurnersGoWest** is a website that will aid in the planning and execution of a successful trip through Utah, Arizona and New Mexico's state parks._


### Core Features

Wild America has a lot to offer it's visitors. In order to make the best use of our time, this website will feature the following: 

  - A Discussion page
  - An Itinerary page which will access a weather API in order to give us the best predictions on given days.
  - A Photos page where our memories can be captured and uploaded for others to see.

Future future features please refer to the [Post-MVP](#Post-MVP) section .

### Goals

- _Users should be able to login, comment and upload material_
  - 

### Team

Created, designed, and developed by [JP Meyers](https://github.com/johnpmeyers20) in preparation for interview with Vlocity/Salesforce.
